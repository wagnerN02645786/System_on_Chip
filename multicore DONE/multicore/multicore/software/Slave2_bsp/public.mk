...
# setting hal.stderr is JTAGSlave2
ELF_PATCH_FLAG  += --stderr_dev JTAGSlave2

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is JTAGSlave2
ELF_PATCH_FLAG  += --stdin_dev JTAGSlave2
...
# setting hal.stdout is JTAGSlave2
ELF_PATCH_FLAG  += --stdout_dev JTAGSlave2

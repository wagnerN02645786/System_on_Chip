...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../multicore.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Embedded.sopcinfo
...
# setting hal.stderr is JTAGSlave1
ELF_PATCH_FLAG  += --stderr_dev JTAGSlave1

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is JTAGSlave1
ELF_PATCH_FLAG  += --stdin_dev JTAGSlave1
...
# setting hal.stdout is JTAGSlave1
ELF_PATCH_FLAG  += --stdout_dev JTAGSlave1

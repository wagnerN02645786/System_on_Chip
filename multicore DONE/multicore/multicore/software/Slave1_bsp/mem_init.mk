...
# Memory: MEMSlave1
MEM_0 := Embedded_MEMSlave1
$(MEM_0)_NAME := MEMSlave1
...
$(MEM_0)_END := 0x0013387f
$(MEM_0)_SPAN := 0x00013880
$(MEM_0)_HIERARCHICAL_PATH := MEMSlave1
$(MEM_0)_WIDTH := 32
...
.PHONY: MEMSlave1
MEMSlave1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

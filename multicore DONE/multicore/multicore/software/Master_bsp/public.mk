...
# setting hal.stderr is JTAGMaster
ELF_PATCH_FLAG  += --stderr_dev JTAGMaster

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is JTAGMaster
ELF_PATCH_FLAG  += --stdin_dev JTAGMaster
...
# setting hal.stdout is JTAGMaster
ELF_PATCH_FLAG  += --stdout_dev JTAGMaster

...
# Memory: MEMMaster
MEM_0 := Embedded_MEMMaster
$(MEM_0)_NAME := MEMMaster
...
$(MEM_0)_HIERARCHICAL_PATH := MEMMaster
$(MEM_0)_WIDTH := 32
...
.PHONY: MEMMaster
MEMMaster: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

...
`timescale 1 ps / 1 ps
module Embedded_mm_interconnect_2 (
		input  wire        clk_0_clk_clk,                               //                             clk_0_clk.clk
		input  wire        CPUSlave2_reset_reset_bridge_in_reset_reset, // CPUSlave2_reset_reset_bridge_in_reset.reset
	...
	wire  [98:0] jtagslave2_avalon_jtag_slave_agent_rf_source_data;                               // JTAGSlave2_avalon_jtag_slave_agent:rf_source_data -> JTAGSlave2_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [98:0] jtagslave2_avalon_jtag_slave_agent_rsp_fifo_out_data;                            // JTAGSlave2_avalon_jtag_slave_agent_rsp_fifo:out_data -> JTAGSlave2_avalon_jtag_slave_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                               // cmd_mux:src_valid -> JTAGSlave2_avalon_jtag_slave_agent:cp_valid
	wire  [97:0] cmd_mux_src_data;                                                                // cmd_mux:src_data -> JTAGSlave2_avalon_jtag_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                               // JTAGSlave2_avalon_jtag_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> JTAGSlave2_avalon_jtag_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                       // cmd_mux:src_startofpacket -> JTAGSlave2_avalon_jtag_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                         // cmd_mux:src_endofpacket -> JTAGSlave2_avalon_jtag_slave_agent:cp_endofpacket
	...
	wire  [98:0] cpuslave2_debug_mem_slave_agent_rf_source_data;                                  // CPUSlave2_debug_mem_slave_agent:rf_source_data -> CPUSlave2_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [98:0] cpuslave2_debug_mem_slave_agent_rsp_fifo_out_data;                               // CPUSlave2_debug_mem_slave_agent_rsp_fifo:out_data -> CPUSlave2_debug_mem_slave_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                           // cmd_mux_001:src_valid -> CPUSlave2_debug_mem_slave_agent:cp_valid
	wire  [97:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> CPUSlave2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                           // CPUSlave2_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> CPUSlave2_debug_mem_slave_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                   // cmd_mux_001:src_startofpacket -> CPUSlave2_debug_mem_slave_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                     // cmd_mux_001:src_endofpacket -> CPUSlave2_debug_mem_slave_agent:cp_endofpacket
	...
	wire  [98:0] memslave2_s1_agent_rf_source_data;                                               // MEMSlave2_s1_agent:rf_source_data -> MEMSlave2_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] memslave2_s1_agent_rsp_fifo_out_data;                                            // MEMSlave2_s1_agent_rsp_fifo:out_data -> MEMSlave2_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                           // cmd_mux_002:src_valid -> MEMSlave2_s1_agent:cp_valid
	wire  [97:0] cmd_mux_002_src_data;                                                            // cmd_mux_002:src_data -> MEMSlave2_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                           // MEMSlave2_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                         // cmd_mux_002:src_channel -> MEMSlave2_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                   // cmd_mux_002:src_startofpacket -> MEMSlave2_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                     // cmd_mux_002:src_endofpacket -> MEMSlave2_s1_agent:cp_endofpacket
	...
	wire  [98:0] pioslave2_s1_agent_rf_source_data;                                               // PIOSlave2_s1_agent:rf_source_data -> PIOSlave2_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] pioslave2_s1_agent_rsp_fifo_out_data;                                            // PIOSlave2_s1_agent_rsp_fifo:out_data -> PIOSlave2_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                           // cmd_mux_003:src_valid -> PIOSlave2_s1_agent:cp_valid
	wire  [97:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> PIOSlave2_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                           // PIOSlave2_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> PIOSlave2_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                   // cmd_mux_003:src_startofpacket -> PIOSlave2_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                     // cmd_mux_003:src_endofpacket -> PIOSlave2_s1_agent:cp_endofpacket
	...
	wire  [98:0] ledrslave2_s1_agent_rf_source_data;                                              // LEDRSlave2_s1_agent:rf_source_data -> LEDRSlave2_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] ledrslave2_s1_agent_rsp_fifo_out_data;                                           // LEDRSlave2_s1_agent_rsp_fifo:out_data -> LEDRSlave2_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                           // cmd_mux_004:src_valid -> LEDRSlave2_s1_agent:cp_valid
	wire  [97:0] cmd_mux_004_src_data;                                                            // cmd_mux_004:src_data -> LEDRSlave2_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                           // LEDRSlave2_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                         // cmd_mux_004:src_channel -> LEDRSlave2_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                   // cmd_mux_004:src_startofpacket -> LEDRSlave2_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                     // cmd_mux_004:src_endofpacket -> LEDRSlave2_s1_agent:cp_endofpacket
	wire         cpuslave2_data_master_agent_cp_valid;                                            // CPUSlave2_data_master_agent:cp_valid -> router:sink_valid
	wire  [97:0] cpuslave2_data_master_agent_cp_data;                                             // CPUSlave2_data_master_agent:cp_data -> router:sink_data
	wire         cpuslave2_data_master_agent_cp_ready;                                            // router:sink_ready -> CPUSlave2_data_master_agent:cp_ready
	wire         cpuslave2_data_master_agent_cp_startofpacket;                                    // CPUSlave2_data_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire         cpuslave2_data_master_agent_cp_endofpacket;                                      // CPUSlave2_data_master_agent:cp_endofpacket -> router:sink_endofpacket
	wire         cpuslave2_instruction_master_agent_cp_valid;                                     // CPUSlave2_instruction_master_agent:cp_valid -> router_001:sink_valid
	wire  [97:0] cpuslave2_instruction_master_agent_cp_data;                                      // CPUSlave2_instruction_master_agent:cp_data -> router_001:sink_data
	wire         cpuslave2_instruction_master_agent_cp_ready;                                     // router_001:sink_ready -> CPUSlave2_instruction_master_agent:cp_ready
	wire         cpuslave2_instruction_master_agent_cp_startofpacket;                             // CPUSlave2_instruction_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire         cpuslave2_instruction_master_agent_cp_endofpacket;                               // CPUSlave2_instruction_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	wire         jtagslave2_avalon_jtag_slave_agent_rp_valid;                                     // JTAGSlave2_avalon_jtag_slave_agent:rp_valid -> router_002:sink_valid
	wire  [97:0] jtagslave2_avalon_jtag_slave_agent_rp_data;                                      // JTAGSlave2_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	wire         jtagslave2_avalon_jtag_slave_agent_rp_ready;                                     // router_002:sink_ready -> JTAGSlave2_avalon_jtag_slave_agent:rp_ready
	wire         jtagslave2_avalon_jtag_slave_agent_rp_startofpacket;                             // JTAGSlave2_avalon_jtag_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         jtagslave2_avalon_jtag_slave_agent_rp_endofpacket;                               // JTAGSlave2_avalon_jtag_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         cpuslave2_debug_mem_slave_agent_rp_valid;                                        // CPUSlave2_debug_mem_slave_agent:rp_valid -> router_003:sink_valid
	wire  [97:0] cpuslave2_debug_mem_slave_agent_rp_data;                                         // CPUSlave2_debug_mem_slave_agent:rp_data -> router_003:sink_data
	wire         cpuslave2_debug_mem_slave_agent_rp_ready;                                        // router_003:sink_ready -> CPUSlave2_debug_mem_slave_agent:rp_ready
	wire         cpuslave2_debug_mem_slave_agent_rp_startofpacket;                                // CPUSlave2_debug_mem_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         cpuslave2_debug_mem_slave_agent_rp_endofpacket;                                  // CPUSlave2_debug_mem_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         memslave2_s1_agent_rp_valid;                                                     // MEMSlave2_s1_agent:rp_valid -> router_004:sink_valid
	wire  [97:0] memslave2_s1_agent_rp_data;                                                      // MEMSlave2_s1_agent:rp_data -> router_004:sink_data
	wire         memslave2_s1_agent_rp_ready;                                                     // router_004:sink_ready -> MEMSlave2_s1_agent:rp_ready
	wire         memslave2_s1_agent_rp_startofpacket;                                             // MEMSlave2_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         memslave2_s1_agent_rp_endofpacket;                                               // MEMSlave2_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         pioslave2_s1_agent_rp_valid;                                                     // PIOSlave2_s1_agent:rp_valid -> router_005:sink_valid
	wire  [97:0] pioslave2_s1_agent_rp_data;                                                      // PIOSlave2_s1_agent:rp_data -> router_005:sink_data
	wire         pioslave2_s1_agent_rp_ready;                                                     // router_005:sink_ready -> PIOSlave2_s1_agent:rp_ready
	wire         pioslave2_s1_agent_rp_startofpacket;                                             // PIOSlave2_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         pioslave2_s1_agent_rp_endofpacket;                                               // PIOSlave2_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         ledrslave2_s1_agent_rp_valid;                                                    // LEDRSlave2_s1_agent:rp_valid -> router_006:sink_valid
	wire  [97:0] ledrslave2_s1_agent_rp_data;                                                     // LEDRSlave2_s1_agent:rp_data -> router_006:sink_data
	wire         ledrslave2_s1_agent_rp_ready;                                                    // router_006:sink_ready -> LEDRSlave2_s1_agent:rp_ready
	wire         ledrslave2_s1_agent_rp_startofpacket;                                            // LEDRSlave2_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         ledrslave2_s1_agent_rp_endofpacket;                                              // LEDRSlave2_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         router_src_valid;                                                                // router:src_valid -> CPUSlave2_data_master_limiter:cmd_sink_valid
	wire  [97:0] router_src_data;                                                                 // router:src_data -> CPUSlave2_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                                // CPUSlave2_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [4:0] router_src_channel;                                                              // router:src_channel -> CPUSlave2_data_master_limiter:cmd_sink_channel
	wire         router_src_startofpacket;                                                        // router:src_startofpacket -> CPUSlave2_data_master_limiter:cmd_sink_startofpacket
	wire         router_src_endofpacket;                                                          // router:src_endofpacket -> CPUSlave2_data_master_limiter:cmd_sink_endofpacket
	wire  [97:0] cpuslave2_data_master_limiter_cmd_src_data;                                      // CPUSlave2_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         cpuslave2_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> CPUSlave2_data_master_limiter:cmd_src_ready
	wire   [4:0] cpuslave2_data_master_limiter_cmd_src_channel;                                   // CPUSlave2_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire         cpuslave2_data_master_limiter_cmd_src_startofpacket;                             // CPUSlave2_data_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire         cpuslave2_data_master_limiter_cmd_src_endofpacket;                               // CPUSlave2_data_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire         rsp_mux_src_valid;                                                               // rsp_mux:src_valid -> CPUSlave2_data_master_limiter:rsp_sink_valid
	wire  [97:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> CPUSlave2_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                               // CPUSlave2_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [4:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> CPUSlave2_data_master_limiter:rsp_sink_channel
	wire         rsp_mux_src_startofpacket;                                                       // rsp_mux:src_startofpacket -> CPUSlave2_data_master_limiter:rsp_sink_startofpacket
	wire         rsp_mux_src_endofpacket;                                                         // rsp_mux:src_endofpacket -> CPUSlave2_data_master_limiter:rsp_sink_endofpacket
	...
	wire  [97:0] cpuslave2_data_master_limiter_rsp_src_data;                                      // CPUSlave2_data_master_limiter:rsp_src_data -> CPUSlave2_data_master_agent:rp_data
	...
	wire   [4:0] cpuslave2_data_master_limiter_rsp_src_channel;                                   // CPUSlave2_data_master_limiter:rsp_src_channel -> CPUSlave2_data_master_agent:rp_channel
	...
	wire         router_001_src_valid;                                                            // router_001:src_valid -> CPUSlave2_instruction_master_limiter:cmd_sink_valid
	wire  [97:0] router_001_src_data;                                                             // router_001:src_data -> CPUSlave2_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                            // CPUSlave2_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [4:0] router_001_src_channel;                                                          // router_001:src_channel -> CPUSlave2_instruction_master_limiter:cmd_sink_channel
	wire         router_001_src_startofpacket;                                                    // router_001:src_startofpacket -> CPUSlave2_instruction_master_limiter:cmd_sink_startofpacket
	wire         router_001_src_endofpacket;                                                      // router_001:src_endofpacket -> CPUSlave2_instruction_master_limiter:cmd_sink_endofpacket
	wire  [97:0] cpuslave2_instruction_master_limiter_cmd_src_data;                               // CPUSlave2_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	wire         cpuslave2_instruction_master_limiter_cmd_src_ready;                              // cmd_demux_001:sink_ready -> CPUSlave2_instruction_master_limiter:cmd_src_ready
	wire   [4:0] cpuslave2_instruction_master_limiter_cmd_src_channel;                            // CPUSlave2_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	wire         cpuslave2_instruction_master_limiter_cmd_src_startofpacket;                      // CPUSlave2_instruction_master_limiter:cmd_src_startofpacket -> cmd_demux_001:sink_startofpacket
	wire         cpuslave2_instruction_master_limiter_cmd_src_endofpacket;                        // CPUSlave2_instruction_master_limiter:cmd_src_endofpacket -> cmd_demux_001:sink_endofpacket
	wire         rsp_mux_001_src_valid;                                                           // rsp_mux_001:src_valid -> CPUSlave2_instruction_master_limiter:rsp_sink_valid
	wire  [97:0] rsp_mux_001_src_data;                                                            // rsp_mux_001:src_data -> CPUSlave2_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                           // CPUSlave2_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [4:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> CPUSlave2_instruction_master_limiter:rsp_sink_channel
	wire         rsp_mux_001_src_startofpacket;                                                   // rsp_mux_001:src_startofpacket -> CPUSlave2_instruction_master_limiter:rsp_sink_startofpacket
	wire         rsp_mux_001_src_endofpacket;                                                     // rsp_mux_001:src_endofpacket -> CPUSlave2_instruction_master_limiter:rsp_sink_endofpacket
	...
	wire  [97:0] cpuslave2_instruction_master_limiter_rsp_src_data;                               // CPUSlave2_instruction_master_limiter:rsp_src_data -> CPUSlave2_instruction_master_agent:rp_data
	...
	wire   [4:0] cpuslave2_instruction_master_limiter_rsp_src_channel;                            // CPUSlave2_instruction_master_limiter:rsp_src_channel -> CPUSlave2_instruction_master_agent:rp_channel
	...
	wire   [4:0] cpuslave2_data_master_limiter_cmd_valid_data;                                    // CPUSlave2_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [4:0] cpuslave2_instruction_master_limiter_cmd_valid_data;                             // CPUSlave2_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	wire         jtagslave2_avalon_jtag_slave_agent_rdata_fifo_src_valid;                         // JTAGSlave2_avalon_jtag_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] jtagslave2_avalon_jtag_slave_agent_rdata_fifo_src_data;                          // JTAGSlave2_avalon_jtag_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         jtagslave2_avalon_jtag_slave_agent_rdata_fifo_src_ready;                         // avalon_st_adapter:in_0_ready -> JTAGSlave2_avalon_jtag_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                   // avalon_st_adapter:out_0_valid -> JTAGSlave2_avalon_jtag_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                    // avalon_st_adapter:out_0_data -> JTAGSlave2_avalon_jtag_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                   // JTAGSlave2_avalon_jtag_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                   // avalon_st_adapter:out_0_error -> JTAGSlave2_avalon_jtag_slave_agent:rdata_fifo_sink_error
	wire         cpuslave2_debug_mem_slave_agent_rdata_fifo_src_valid;                            // CPUSlave2_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] cpuslave2_debug_mem_slave_agent_rdata_fifo_src_data;                             // CPUSlave2_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         cpuslave2_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> CPUSlave2_debug_mem_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                               // avalon_st_adapter_001:out_0_valid -> CPUSlave2_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                // avalon_st_adapter_001:out_0_data -> CPUSlave2_debug_mem_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                               // CPUSlave2_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                               // avalon_st_adapter_001:out_0_error -> CPUSlave2_debug_mem_slave_agent:rdata_fifo_sink_error
	wire         memslave2_s1_agent_rdata_fifo_src_valid;                                         // MEMSlave2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] memslave2_s1_agent_rdata_fifo_src_data;                                          // MEMSlave2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         memslave2_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_002:in_0_ready -> MEMSlave2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                               // avalon_st_adapter_002:out_0_valid -> MEMSlave2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                // avalon_st_adapter_002:out_0_data -> MEMSlave2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                               // MEMSlave2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                               // avalon_st_adapter_002:out_0_error -> MEMSlave2_s1_agent:rdata_fifo_sink_error
	wire         pioslave2_s1_agent_rdata_fifo_src_valid;                                         // PIOSlave2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pioslave2_s1_agent_rdata_fifo_src_data;                                          // PIOSlave2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pioslave2_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_003:in_0_ready -> PIOSlave2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                               // avalon_st_adapter_003:out_0_valid -> PIOSlave2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                // avalon_st_adapter_003:out_0_data -> PIOSlave2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                               // PIOSlave2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                               // avalon_st_adapter_003:out_0_error -> PIOSlave2_s1_agent:rdata_fifo_sink_error
	wire         ledrslave2_s1_agent_rdata_fifo_src_valid;                                        // LEDRSlave2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] ledrslave2_s1_agent_rdata_fifo_src_data;                                         // LEDRSlave2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         ledrslave2_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_004:in_0_ready -> LEDRSlave2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                               // avalon_st_adapter_004:out_0_valid -> LEDRSlave2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                // avalon_st_adapter_004:out_0_data -> LEDRSlave2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                               // LEDRSlave2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                               // avalon_st_adapter_004:out_0_error -> LEDRSlave2_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.reset                  (CPUSlave2_reset_reset_bridge_in_reset_reset),                              //                     reset.reset
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                            //       clk.clk
		.reset                 (CPUSlave2_reset_reset_bridge_in_reset_reset),                              // clk_reset.reset
	...
	Embedded_mm_interconnect_2_router router (
	...
	Embedded_mm_interconnect_2_router_001 router_001 (
	...
	Embedded_mm_interconnect_2_router_002 router_002 (
	...
	Embedded_mm_interconnect_2_router_003 router_003 (
	...
	Embedded_mm_interconnect_2_router_003 router_004 (
	...
	Embedded_mm_interconnect_2_router_002 router_005 (
	...
	Embedded_mm_interconnect_2_router_002 router_006 (
	...
	Embedded_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                       //        clk.clk
		.reset              (CPUSlave2_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	Embedded_mm_interconnect_2_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                              //        clk.clk
		.reset              (CPUSlave2_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	Embedded_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_2_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (CPUSlave2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embedded_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (CPUSlave2_reset_reset_bridge_in_reset_reset),             // in_rst_0.reset
